...
import { TypeChecker } from '../visitors/visitor';
    ...
    function serializeClass(symbol: ts.Symbol) {
        ...
        if (symbol.members)
            symbol.members.forEach(element => {
                ...
                debugger;
                if (Array.isArray(details.properties)) details.properties.push(element)
            })
        return details;
    }
...
generateDocumentation([join(__dirname, "1.ts"), join(__dirname, "2.ts")], {
