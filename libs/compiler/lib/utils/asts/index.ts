import { TypeVisitor, TypeContext, TypeVisitorType } from '../../visitor3/typeVisitor';
import { TypeNode } from '../../visitors/visitor';
import { MagnusContext } from '../../visitors/magnus';
export function createTypeNode(node: TypeNode, context: MagnusContext): TypeVisitorType {
...
export function findCurrentEntity(type: TypeVisitorType): TypeVisitorType | undefined {
...
export function createTypeName(type: TypeVisitorType, currentEntity: string): string {
