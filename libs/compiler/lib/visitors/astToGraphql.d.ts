...
export declare class AstToGraphqlVisitor implements ast.Visitor {
    ...
    collectCls(node: ts.ClassDeclaration, context: CollectionContext): ast.InputObjectTypeDefinitionAst<any, any> | ast.InterfaceTypeDefinitionAst<any, any> | ast.ScalarTypeDefinitionAst<any, any> | undefined;
