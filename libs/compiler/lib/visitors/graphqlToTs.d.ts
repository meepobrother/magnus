...
export declare class GraphqlToTs implements ast.Visitor {
    ...
    getSchema(operation: string): ast.InputObjectTypeDefinitionAst<any, any> | ast.ScalarTypeExtensionAst<any, any> | ast.ObjectTypeExtensionAst<any, any> | ast.InterfaceTypeExtensionAst<any, any> | ast.UnionTypeExtensionAst<any, any> | ast.EnumTypeExtensionAst<any, any> | ast.InputObjectTypeExtensionAst<any, any> | ast.OperationDefinitionAst<any, any> | ast.FragmentDefinitionAst<any, any> | ast.SchemaDefinitionAst<any, any> | ast.ScalarTypeDefinitionAst<any, any> | ast.ObjectTypeDefinitionAst<any, any> | ast.InterfaceTypeDefinitionAst<any, any> | ast.UnionTypeDefinitionAst<any, any> | ast.EnumTypeDefinitionAst<any, any> | ast.DirectiveDefinitionAst<any, any> | ast.SchemaExtensionAst<any, any> | undefined;
    private __getType;
