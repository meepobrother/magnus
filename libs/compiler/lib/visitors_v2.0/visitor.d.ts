...
export declare class JSDocReturnTag extends Node<ts.JSDocReturnTag> {
...
export declare class AssignmentExpression<TOperator extends ts.AssignmentOperatorToken> extends BinaryExpression {
    left: LeftHandSideExpression;
    operatorToken: TOperator;
    visit(visitor: Visitor, context: any): void;
}
export declare class ObjectDestructuringAssignment extends AssignmentExpression<ts.EqualsToken> {
    left: ObjectLiteralExpression;
    visit(visitor: Visitor, context: any): void;
}
export declare class ArrayDestructuringAssignment extends AssignmentExpression<ts.EqualsToken> {
...
export declare class TsVisitor implements Visitor {
    ...
    visitModuleReference(node: any, context: ts.ModuleReference): any;
    ...
    visitExpression(node: any, context: ts.Expression): StringLiteral | NumericLiteral | ObjectLiteralExpression | ArrayLiteralExpression | Identifier | AsExpression | AwaitExpression | ArrowFunction | BooleanLiteral | CallExpression | BinaryExpression | ElementAccessExpression | PropertyAccessExpression | PrefixUnaryExpression | TemplateExpression | NewExpression | ThisExpression | NoSubstitutionTemplateLiteral | ConditionalExpression | SpreadElement | TaggedTemplateExpression | ParenthesizedExpression | RegularExpressionLiteral;
     ...
     * type node end
     */
    visitEntityName(node: any, context: ts.EntityName): EntityName;
