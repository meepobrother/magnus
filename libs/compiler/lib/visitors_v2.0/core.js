...
class CoreVisitor {
    ...
    visitSourceFile(node, context) {
        if (context.resolvedModules)
            this.resolvedModules = context.resolvedModules;
...
exports.CoreVisitor = CoreVisitor;
class CoreExport extends CoreVisitor {
    constructor() {
        super(...arguments);
        this.name = `CoreExport`;
    }
}
exports.CoreExport = CoreExport;
