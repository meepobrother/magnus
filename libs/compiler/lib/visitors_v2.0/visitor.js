...
exports.Node = Node;
class JSDocReturnTag extends Node {
...
class ObjectDestructuringAssignment extends AssignmentExpression {
    visit(visitor, context) { }
}
exports.ObjectDestructuringAssignment = ObjectDestructuringAssignment;
class ArrayDestructuringAssignment extends AssignmentExpression {
    visit(visitor, context) { }
}
