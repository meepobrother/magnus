...
export function toJson(node: ast.DocumentAst): l.DocumentNode {
    ...
    const str = node.visit(visitor, {});
    str.isEmpty = visitor.isEmpty;
    return str;
}
...
export class ToJsonVisitor<C = any> implements ast.Visitor<C, l.ASTNode> {
    ...
    visitTypeDefinitionAst(
        node: ast.TypeDefinitionAst<C, l.ASTNode>,
        context: C
    ): l.ASTNode {
        return node.visit(this, context);
    }
    visitDefinitionAst(
        node: ast.DefinitionAst<C, l.ASTNode>,
        context: C
    ): l.ASTNode {
        return node.visit(this, context);
    }
    ...
    visitTypeSystemDefinitionAst(
        node: ast.TypeSystemDefinitionAst,
        context: C
    ): l.ASTNode {
        return node.visit(this, context);
    }

    visitExecutableDefinitionAst(
        node: ast.ExecutableDefinitionAst,
        context: C
    ): l.ASTNode {
        return node.visit(this, context);
    }
    ...
    visitSchemaExtensionNode(
        node: ast.SchemaExtensionAst,
        context: C
    ): l.SchemaDefinitionNode {
        return {
    ...
    visitTypeExtensionNode(
        node: ast.TypeExtensionAst,
        context: C
    ): l.TypeExtensionNode {
        return node.visit(this, context);
    }

    visitTypeSystemExtensionNode(
        node: ast.TypeSystemExtensionAst,
        context: C
    ): l.ASTNode {
        return node.visit(this, context);
    }
    ...
    visitBooleanValueAst(
        node: ast.BooleanValueAst,
        context: C
    ): l.BooleanValueNode {
        return {
            kind: "BooleanValue",
    ...
    visitUnionTypeExtensionAst(
        node: ast.UnionTypeExtensionAst,
        context: C
    ): l.UnionTypeExtensionNode {
        return {
            kind: "UnionTypeExtension",
            name: node.name && node.name.visit(this, context),
            directives: node.directives.map(directive =>
                directive.visit(this, context)
            )
        };
    }

    visitScalarTypeExtensionAst(
        node: ast.ScalarTypeExtensionAst,
        context: C
    ): l.ScalarTypeExtensionNode {
        return {
    ...
    visitObjectTypeExtensionAst(
        node: ast.ObjectTypeExtensionAst,
        context: C
    ): l.ObjectTypeExtensionNode {
        return {
    ...
    visitInterfaceTypeExtensionAst(
        node: ast.InterfaceTypeExtensionAst,
        context: C
    ): l.InterfaceTypeExtensionNode {
        return {
    ...
    visitFieldDefinitionAst(
        ...
        try {
            ...
            const item: any = {
                ...
                name,
                arguments:
                    node.arguments && node.arguments.map(arg => arg.visit(this, context)),
    ...
    visitEnumTypeExtensionAst(
        node: ast.EnumTypeExtensionAst,
        context: C
    ): l.EnumTypeExtensionNode {
        return {
    ...
    visitEnumValueDefinitionAst(
        node: ast.EnumValueDefinitionAst,
        context: C
    ): l.EnumValueDefinitionNode {
        return {
    ...
    visitInputObjectTypeExtensionAst(
        node: ast.InputObjectTypeExtensionAst,
        context: C
    ): l.InputObjectTypeExtensionNode {
        return {
    ...
    visitOperationDefinitionAst(
        node: ast.OperationDefinitionAst,
        context: C
    ): l.OperationDefinitionNode {
        return {
            kind: "OperationDefinition",
            operation: node.operation,
            name: node.name && node.name.visit(this, context),
            variableDefinitions: node.variableDefinitions.map(variable =>
                variable.visit(this, context)
            ),
            directives: node.directives.map(dir => dir.visit(this, context)),
    ...
    visitFragmentSpreadAst(
        node: ast.FragmentSpreadAst,
        context: C
    ): l.FragmentSpreadNode {
        return {
            kind: "FragmentSpread",
            name: node.name && node.name.visit(this, context),
            directives: node.directives.map(dir => dir.visit(this, context))
    ...
    visitInlineFragmentAst(
        node: ast.InlineFragmentAst,
        context: C
    ): l.InlineFragmentNode {
        return {
            kind: "InlineFragment",
    ...
    visitVariableDefinitionAst(
        node: ast.VariableDefinitionAst,
        context: C
    ): l.VariableDefinitionNode {
        return {
    ...
    visitSelectionSetAst(
        node: ast.SelectionSetAst,
        context: C
    ): l.SelectionSetNode {
        return {
            kind: "SelectionSet",
    ...
    visitFragmentDefinitionAst(
        node: ast.FragmentDefinitionAst,
        context: C
    ): l.FragmentDefinitionNode {
        return {
            ...
            typeCondition:
                node.typeCondition && node.typeCondition.visit(this, context),
            directives: node.directives.map(dir => dir.visit(this, context)),
            selectionSet: node.selectionSet && node.selectionSet.visit(this, context)
        };
    }
    visitSchemaDefinitionAst(
        node: ast.SchemaDefinitionAst,
        context: C
    ): l.SchemaDefinitionNode {
        return {
            kind: "SchemaDefinition",
    ...
    visitOperationTypeDefinitionAst(
        node: ast.OperationTypeDefinitionAst,
        context: C
    ): l.OperationTypeDefinitionNode {
        return {
    ...
    visitDirectiveDefinitionAst(
        node: ast.DirectiveDefinitionAst,
        context: C
    ): l.DirectiveDefinitionNode {
        return {
    ...
    visitObjectTypeDefinitionAst(
        ...
        try {
            ...
            return {
                ...
                fields:
                    node.fields && node.fields.map(field => field.visit(this, context))
            };
        } catch (e) {
            throw e;
        }
    }
    visitInterfaceTypeDefinitionAst(
        node: ast.InterfaceTypeDefinitionAst,
        context: C
    ): l.InterfaceTypeDefinitionNode {
        return {
    ...
    visitUnionTypeDefinitionAst(
        node: ast.UnionTypeDefinitionAst,
        context: C
    ): any {
        return {
    ...
    visitEnumTypeDefinitionAst(
        node: ast.EnumTypeDefinitionAst,
        context: C
    ): l.EnumTypeDefinitionNode {
        return {
    ...
    visitInputObjectTypeDefinitionAst(
        ...
        context: C
    ): l.InputObjectTypeDefinitionNode {
        try {
            return {
    ...
    visitSchemaExtensionAst(
        node: ast.SchemaExtensionAst,
        context: C
    ): l.SchemaExtensionNode {
        return {
